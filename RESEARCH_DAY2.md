...
1. **Define Creative Director prompt** — what aesthetic/narrative reasoning should it do?
2. **Map feedback loop timing** — when do agents talk, when do they wait?
3. **Extend manifest schema** — add `creative_feedback[]`, `budget_decision`, `artistic_direction`
4. **Prototype decision rules in Producer** — how to resolve conflicting feedback?
5. **Write test cases** — what does a successful creative loop look like?
